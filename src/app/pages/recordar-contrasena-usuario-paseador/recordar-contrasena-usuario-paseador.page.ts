...
@Component({
  selector: 'app-recordar-contrasena-usuario-paseador',
  templateUrl: './recordar-contrasena-usuario-paseador.page.html',
  styleUrls: ['./recordar-contrasena-usuario-paseador.page.scss'],
})
export class RecordarContrasenaUsuarioPaseadorPage implements OnInit {
