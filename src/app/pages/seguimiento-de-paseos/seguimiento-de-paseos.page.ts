...
@Component({
  selector: 'app-seguimiento-de-paseos',
  templateUrl: './seguimiento-de-paseos.page.html',
  styleUrls: ['./seguimiento-de-paseos.page.scss'],
})
export class SeguimientoDePaseosPage implements OnInit {
