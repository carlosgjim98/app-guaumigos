...
@Component({
  selector: 'app-mensaje-chat-empresa',
  templateUrl: './mensaje-chat-empresa.page.html',
  styleUrls: ['./mensaje-chat-empresa.page.scss'],
})
export class MensajeChatEmpresaPage implements OnInit {
