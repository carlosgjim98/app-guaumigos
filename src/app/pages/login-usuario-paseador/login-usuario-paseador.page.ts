...
@Component({
  selector: 'app-login-usuario-paseador',
  templateUrl: './login-usuario-paseador.page.html',
  styleUrls: ['./login-usuario-paseador.page.scss'],
})
export class LoginUsuarioPaseadorPage implements OnInit {
